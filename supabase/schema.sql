...
CREATE TABLE IF NOT EXISTS users (
  ...
  petal_coins INTEGER NOT NULL DEFAULT 0,
  theme TEXT,
  garden_bg TEXT,
  last_check_in_at BIGINT,
  check_in_streak INTEGER NOT NULL DEFAULT 0,
  total_checkin_days INTEGER NOT NULL DEFAULT 0,
  total_checkin_days_accum INTEGER NOT NULL DEFAULT 0,
  incoming_friend_requests JSONB NOT NULL DEFAULT '[]',
  outgoing_friend_requests JSONB NOT NULL DEFAULT '[]',
  task_progress JSONB NOT NULL DEFAULT '{}',
  task_claimed JSONB NOT NULL DEFAULT '{}',
  task_last_reset JSONB NOT NULL DEFAULT '{}',
  -- 偷花相关
...
('ann_1', '🎉 欢迎来到花园！', '欢迎来到花园模拟经营游戏！在这里你可以种花、交易、交友。完成签到和任务获取金币与花瓣奖励，解锁称号和外观，快去你的花园看看吧！', 'urgent', EXTRACT(EPOCH FROM NOW()) * 1000),
('ann_2', '📖 游戏玩法介绍', '1. 在花园中种植花朵，浇水、施肥、除虫、使用加速卡加速成长，注意虫灾哦。
...
8. 外观设置：切换界面主题与花园背景皮肤，打造专属花园。', 'important', EXTRACT(EPOCH FROM NOW()) * 1000 - 3600000)
ON CONFLICT (id) DO NOTHING;
