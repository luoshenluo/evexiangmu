          ...
          >
            {icon && (
              <div className="mx-auto mb-3 flex h-14 w-14 items-center justify-center rounded-full">
                <div className={`flex h-12 w-12 items-center justify-center rounded-full ${iconBgClass} ${iconColorClass}`}>
                  {icon}
                </div>
              </div>
            )}
            ...
            {description && (
              <p className="mt-1.5 text-center text-sm text-[#A0A0A0]">{description}</p>
            )}
